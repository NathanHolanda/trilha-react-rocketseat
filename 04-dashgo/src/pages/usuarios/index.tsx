import { Box, Button, Text, Checkbox, Flex, Heading, Icon, Table, Tbody, Td, Th, Thead, Tr, useBreakpointValue, IconButton } from "@chakra-ui/react";
                    ...
                    <Table colorScheme="whiteAlpha" variant="striped">
                        <Thead>
                            <Tr>
                                ...
                                <Th>Usuário</Th>
                                <Th display={ isWideScreen ? "table-cell" : "none" }>
                                    Data de cadastro
                                </Th>
                                <Th w="8"></Th>
                            </Tr>
                        ...
                        <Tbody>
                            <Tr>
                                ...
                                <Td display={ isWideScreen ? "table-cell" : "none" }
                                >
                                    25 de março, 2022
                                </Td>
                                <Td>
